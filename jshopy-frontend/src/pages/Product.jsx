...
const Product = () => {
  ...
  return productData ? (
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='mt-20'>
        <div className='flex'>
          {/* <b className='border border-gray-300 border-r-0 px-5 py-3 text-sm'>Description</b> */}
          <b className="border border-gray-300 border-b-white border-r-0 px-5 py-3 text-sm bg-white">Description</b>
          <p className='border border-gray-300 border-b-white px-5 py-3 text-sm bg-white'>Reviews (155)</p>
        </div>
